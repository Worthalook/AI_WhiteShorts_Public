...
if not exist data\NHL_YTD.csv (
  echo name,team,opponent,home_or_away,date,points> data\NHL_YTD.csv
)

python -m white_shorts.etl.update_history_from_api --history_csv data/NHL_YTD.csv --since_days 2 --key %SPORTSDATA_API_KEY% --backup
if %ERRORLEVEL% NEQ 0 (
